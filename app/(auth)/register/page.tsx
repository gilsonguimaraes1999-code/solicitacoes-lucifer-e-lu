...
export default async function RegisterPage({ searchParams }: { searchParams: Promise<{ erro?: string }> }) {
  ...
  return (
    <>
      <h1 className="mt-6 text-2xl font-bold text-white">Criar conta</h1>
      <p className="mt-2 text-sm text-white/50">Após o cadastro, sua conta aguardará aprovação.</p>
      ...
      <p className="mt-5 text-sm text-gold-soft"><Link href="/login">Voltar ao login</Link></p>
